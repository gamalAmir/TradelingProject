...
import com.Tradeling.Core.ReportFolder;

public class ExtentManager extends ReportFolder{
	private static ExtentReports extent;
	private static Platform platform;
	private static String reportFileName = "ExtentReports-Version3-Test-Automaton-Report.html";
	private static String macPath = System.getProperty("user.dir") + "/TestReport";
	public static String windowsPath = ReportFolder.SetDirectory();
	private static String macReportFileLoc = macPath + "/" + reportFileName;
	private static String winReportFileLoc = windowsPath + "\\" + reportFileName;
	public static String reportDir = windowsPath;
